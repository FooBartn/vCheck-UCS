...
Add-ReportResource "Header-VMware" ($StylePath + "\Header-ucsm.png") -Used $true
...
<html xmlns="http://www.w3.org/1999/xhtml">
   ...
   <body style="padding: 0 10px; margin: 0px; font-family:Arial, Helvetica, sans-serif; ">
      <a name="top" />
        <table width='100%' style='background-color: #016CA0; border-collapse: collapse; border: 0px; margin: 0; padding: 0;'>
         <tr>
            <td>
      ...
      <table width='100%'><tr><td style='background-color: #016CA0; border: 1px solid #016CA0; vertical-align: middle; height: 30px; text-indent: 10px; font-family: Tahoma, sans-serif; font-weight: bold; font-size: 8pt; color: #FFFFFF;'>_HEADER_</td></tr></table>
      <div>_TOC_</div>
      _CONTENT_
   <!-- CustomHTMLClose -->
   <div style='height: 10px; font-size: 10px;'>&nbsp;</div>
